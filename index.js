...
const newMenuItems = [ {name:'steak', price:16, category:'dinner'}, {name:'buiscuits & gravy', price:8.75, category:'breakfast'}, {name:'chicken sandwich', price:6.50, category:'lunch'}];
...
console.log(reviews[5].feedback); // returns Julius' feedback
